...
<div class="mb-8 flex items-end justify-between">
    <div>
        <h2 class="text-3xl font-black text-slate-900 tracking-tight">Add Product</h2>
        <p class="text-slate-500 text-sm mt-1">Create a new product for your catalog.</p>
    </div>
        ...
        <div class="p-6 md:p-8 space-y-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2 md:col-span-2">
                        ...
                        <textarea name="description" rows="4" required
                                  class="w-full px-4 py-3 rounded-lg border border-slate-200 bg-slate-50 focus:bg-white text-sm focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 outline-none transition-all">{{ old('description') }}</textarea>
            ...
            <div class="pt-8 border-t border-slate-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="space-y-2">
                        <label class="text-xs font-bold text-slate-700 uppercase">Initial Stock <span class="text-rose-500">*</span></label>
            ...
            <div class="pt-8 border-t border-slate-100">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-2">
                        ...
                        <p class="text-[11px] text-slate-500 mt-1">Upload a JPEG or PNG image (Max 2MB).</p>
